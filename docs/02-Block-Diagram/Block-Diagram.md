...
Relative humidity is measured using the HDC2080 digital humidity sensor, which communicates with the ESP32-S3 via the I²C interface. Pull-up resistors on the I²C lines ensure reliable communication between the sensor and the microcontroller while maintaining proper bus operation within the system.
...
![Temperature / Humidity Module ](TempHumModualV3.drawio.png)
